...
public class Tech_title extends Activity {
    ...
    public static final String APP_ID = "409883382445334";
    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                try {
                    uploadFileUrl = new URL(
                        "https://fbcdn-sphotos-h-a.akamaihd.net/hphotos-ak-ash4/1401959_692626297428521_334747128_o.jpg");
        ...
        mPostButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                mFacebook.dialog(Tech_title.this, "feed",
    ...
    private void setlisteners() {
        ...
        mText = (TextView) Tech_title.this.findViewById(R.id.txt);
        mRequestButton = (Button) findViewById(R.id.requestButton);
//        suggestion = (TextView) findViewById(R.id.sugg);
    ...
    public class SampleRequestListener extends BaseRequestListener {
        ...
        public void onComplete(final String response, final Object state) {
            try {
                ...
                Tech_title.this.runOnUiThread(new Runnable() {
                    public void run() {
